...
const baseAudio = '../assets/music/evaluasi/pengurangan_';
...
mulai.addEventListener('click', function(){
    ...
    imgNumber = [
        [`${baseImg}evaluasi/pengurangan_1.gif`],
        [`${baseImg}evaluasi/pengurangan_2.gif`],
        [`${baseImg}evaluasi/pengurangan_3.gif`],
        [`${baseImg}evaluasi/pengurangan_4.gif`],
        [`${baseImg}evaluasi/pengurangan_5.gif`],
    ]
