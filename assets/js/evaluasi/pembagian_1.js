...
const baseAudio = '../assets/music/evaluasi/pembagian_';
...
mulai.addEventListener('click', function() {
    ...
    imgNumber = [
        [`${baseImg}evaluasi/pembagian_1.gif`],
        [`${baseImg}evaluasi/pembagian_2.gif`],
        [`${baseImg}evaluasi/pembagian_3.gif`],
        [`${baseImg}evaluasi/pembagian_4.gif`],
        [`${baseImg}evaluasi/pembagian_5.gif`],
    ]
