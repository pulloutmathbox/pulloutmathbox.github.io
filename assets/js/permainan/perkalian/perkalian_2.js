...
mulai.addEventListener('click', function() {
    ...
    helpNumber = [
        [`${baseImg}help/perkalian/level2/1.png`],
        [`${baseImg}help/perkalian/level2/2.png`],
        [`${baseImg}help/perkalian/level2/3.png`],
        [`${baseImg}help/perkalian/level2/4.png`],
        [`${baseImg}help/perkalian/level2/5.png`],
    ]
