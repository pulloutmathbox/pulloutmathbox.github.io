...
const baseAudio = '../../assets/music/perkalian/level_1/perkalian_';
var audio = new Audio();
...
mulai.addEventListener('click', function() {
    ...
    imgNumber = [
        [`${baseImg}angka_gif/perkalian/level1/perkalian_1.gif`],
        [`${baseImg}angka_gif/perkalian/level1/perkalian_2.gif`],
        [`${baseImg}angka_gif/perkalian/level1/perkalian_3.gif`],
