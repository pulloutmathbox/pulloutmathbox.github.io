...
const baseAudio = '../../assets/music/pengurangan/level_3/pengurangan_';
var audio = new Audio();
...
var total = [10, 11, 12, 13, 15];
var kurang = [1, 5, 4, 6, 8];
mulai.addEventListener('click', function() {
    ...
    imgNumber = [
        [`${baseImg}angka_gif/pengurangan/level3/pengurangan_1.gif`],
        [`${baseImg}angka_gif/pengurangan/level3/pengurangan_2.gif`],
        [`${baseImg}angka_gif/pengurangan/level3/pengurangan_3.gif`],
        [`${baseImg}angka_gif/pengurangan/level3/pengurangan_4.gif`],
        [`${baseImg}angka_gif/pengurangan/level3/pengurangan_5.gif`],
    ]
