...
const baseAudio = '../../assets/music/pengurangan/level_1/pengurangan_';
var audio = new Audio();
...
mulai.addEventListener('click', function() {
    ...
    imgNumber = [
        [`${baseImg}angka_gif/pengurangan/level1/pengurangan_1.gif`],
        [`${baseImg}angka_gif/pengurangan/level1/pengurangan_2.gif`],
        [`${baseImg}angka_gif/pengurangan/level1/pengurangan_3.gif`],
        [`${baseImg}angka_gif/pengurangan/level1/pengurangan_4.gif`],
