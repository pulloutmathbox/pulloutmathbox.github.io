...
const baseAudio = '../../assets/music/penjumlahan/level_1/penjumlahan_';
var audio = new Audio();
...
mulai.addEventListener('click', function() {
    ...
    imgNumber = [
        [`${baseImg}angka_gif/penjumlahan/level1/penjumlahan_1.gif`],
        [`${baseImg}angka_gif/penjumlahan/level1/penjumlahan_2.gif`],
        [`${baseImg}angka_gif/penjumlahan/level1/penjumlahan_3.gif`],
        [`${baseImg}angka_gif/penjumlahan/level1/penjumlahan_4.gif`],
        [`${baseImg}angka_gif/penjumlahan/level1/penjumlahan_5.gif`],
    ]
